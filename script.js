...
ov.id='_ab_ov';
ov.innerHTML='<div id="_ab_box"><div id="_ab_scan_line"></div><button id="_ab_close">\u2715<\/button><div id="_ab_logo_wrap"><div id="_ab_logo"><img src="https://raw.githubusercontent.com/freefireob49v2/my-key-system/main/logo.png" id="_ab_img"\/><\/div><div id="_ab_title">Aincrad Bypass<\/div><div id="_ab_sub">MEHEDY Edition<\/div><\/div><div id="_ab_div"><\/div><div id="_ab_circle_sec"><div id="_ab_svg_outer"><svg width="120" height="120" viewBox="0 0 120 120" style="position:absolute;top:0;left:0;"><circle cx="60" cy="60" r="52" fill="none" stroke="rgba(255,255,255,0.05)" stroke-width="5"\/><circle id="_ab_arc" cx="60" cy="60" r="52" fill="none" stroke="#dc2626" stroke-width="5" stroke-dasharray="327" stroke-dashoffset="327" stroke-linecap="round" transform="rotate(-90 60 60)"\/><\/svg><div id="_ab_cnum"><span id="_ab_big_num">50<\/span><span id="_ab_sec_lbl">seconds<\/span><\/div><\/div><div id="_ab_stage_txt">Connecting...<\/div><div id="_ab_status">Please wait<\/div><\/div><label id="_ab_inp_lbl">Access Key<\/label><div id="_ab_inp_wrap"><input id="_ab_inp" type="password" placeholder="Enter key to unlock"\/><button id="_ab_eye" type="button">\ud83d\udc41<\/button><\/div><div id="_ab_err"><\/div><button id="_ab_btn">Unlock & Bypass<\/button><a id="_ab_tg" href="https://t.me/mehedy4644" target="_blank"><svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12L8.32 14.26l-2.96-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.828.3z"\/><\/svg>t.me\/mehedy4644<\/a><\/div>';
